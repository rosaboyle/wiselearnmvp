    ...
    return (
        <>
            ...
            <div style={{ width: "40%", margin: "auto", padding: "80px 0px 0px 0px" }}>
                ...
                <form>
                    <fieldset>
                        <legend>Upload user data</legend>
                        ...
                        <label for="commentField">Comment(Include your privacy policy link etc.)</label>
                        <textarea placeholder="Updates: changed .." id="commentField"></textarea>

                        <button className="button" type="submit">Submit</button>
                        <Link to={`/finish`} ><button className="button" type="submit">Next</button></Link>
