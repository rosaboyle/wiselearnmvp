    ...
    <nav className="navigation">
      ...
      <section className="container">
        ...
        {/* <div className="hamburger">
          <a href="/"><h1 className="title">More</h1></a>
        </div> */}
{/* <div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a href="#">Link 3</a>
        ...
        <a href="/">
          <img src={hm} width="20px" height="20px" />
...
export function Mili() {
  return <>
    <main >
      ...
      <NavigationBar />
      {/* <div > */}
      <div style={{ width: "60%", margin: "auto", padding: "80px 0px 0px 0px" }} className="mainpart" >
